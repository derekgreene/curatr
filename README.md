...
- **Classification Index**: a browsable version of the hierarchical topical index used by the British Museum Library and subsequently by the British Library, until 1985, comprising 70 top-level categories such as "Fiction" and "Geography" and 148 more fine-grained sub-topics.
...
- **Related Volumes**: for any given volume, browse the 50 most similar volumes in the collection, based on pre-computed pairwise similarities.
